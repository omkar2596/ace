...
function Home() {
        ...
        <section className="w3l-courses">
            <div className="blog pb-5" id="courses">
                <div className="container py-lg-5 py-md-4 py-2">
                    ...
                    {/* <h3 className="title-big text-center mb-sm-5 mb-4">Our Facilities</h3> */}
                    <div className="row">
                        <div className="col-lg-4 col-md-6 item">
                            <div className="card">
                                ...
                                <div className="card-body course-details">
                                    ...
                                    <a href="#course-single" className="course-desc">Lorem, ipsum dolor.
                                    </a>
                        ...
                        <div className="col-lg-4 col-md-6 item mt-md-0 mt-5">
                            <div className="card">
                                ...
                                <div className="card-body course-details">
                                    <a href="#course-single" className="course-desc">Lorem, ipsum dolor.</a>                  
                                </div>              
                            </div>
                        </div>
                        ...
                        <div className="col-lg-4 col-md-6 item mt-lg-0 mt-5">
                            <div className="card">
                                ...
                                <div className="card-body course-details">
                                    ...
                                    <a href="#course-single" className="course-desc">Lorem ipsum dolor sit.</a> 
                                </div>
 ...
 {/* video carousel */}
        <section className="w3l-features " id="facilities">
                        ...
                        <div className="col-lg-7 feature-grid-right mt-lg-0 mt-5">
                            <div className="">
                                ...
                                <div className="grids-1 ">
                                    ...
                                    <p>Established in..
                                        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Sit, ullam.Lorem ipsum dolor sit amet consectetur adipisicing elit. Sint quas necessitatibus maxime tempore laborum nemo voluptatibus dicta ratione maiores vitae.Vivamus a ligula quam. Ut blandit eu leo non. Duis sed dolor amet laoreet. Lorem ipsum dolor sit amet consectetur adipisicing elit. Culpa, officia.</p>
                                </div>
